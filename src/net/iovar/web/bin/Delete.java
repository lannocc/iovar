...
public class Delete extends HttpServlet
{
    ...
    public void usage (final HttpServletResponse resp) throws IOException
    {
        ...
        out.println ("usage: delete <resource> [argument]...");
        out.println ();
        out.println ("Deletes resource.");
    ...
    protected void doPost (final HttpServletRequest req, final HttpServletResponse resp) throws IOException
    {
        ...
        try
        {
            Utils.pipe (Transport.handler (resource, params, context, req.getSession ()).delete (), resp.getOutputStream ());
        }
        catch (final IOException e)
        {
            Log.error (e);
            resp.getWriter ().println ("delete: "+e);
