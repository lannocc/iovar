...
public class Put extends HttpServlet
{
    ...
    public void usage (final HttpServletResponse resp) throws IOException
    {
        ...
        out.println ("usage: put <resource> [argument]...");
        out.println ();
        out.println ("Creates resource, with optional data from stdin.");
    ...
    protected void doPost (final HttpServletRequest req, final HttpServletResponse resp) throws IOException
    {
        ...
        try
        {
            Utils.pipe (Transport.handler (resource, params, context, req.getSession ()).put (req.getInputStream ()), resp.getOutputStream ());
        }
        catch (final Exception e)
        {
            Log.error (e);
            resp.getWriter ().println ("put: "+e);
